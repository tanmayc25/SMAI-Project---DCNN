...
if __name__ == '__main__':
    ...
    with open("result_dcnn_1.txt", "a") as file_result:
        ...
        file_result.write('dropout rate: %d\n' % dropout_rate)
    ...
    for epoch in xrange(num_epochs):
    	...
    	file_result.write('Epoch %d/%d, train error: %f. Elapsed time: %.2f seconds' % (epoch+1, num_epochs, epoch_cost, en-st))
    	file_result.write('Test error: %f' % test_error)
